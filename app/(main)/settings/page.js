...
import {
    ...
    Bookmark, Heart, Clock, Star, Users, MessageCircle, Camera
} from 'lucide-react';
    ...
    const settingSections = [
        {
            ...
            items: [
                ...
                { icon: Clock, label: 'Your activity', href: '#' },
                { icon: Bell, label: 'Notifications', href: '#' },
                { icon: Clock, label: 'Time management', href: '#' },
            ],
        },
        {
            ...
            items: [
                ...
                { icon: Users, label: 'Close friends', href: '#' },
                { icon: Eye, label: 'Blocked', href: '#' },
        ...
        return (
            <div style={{ maxWidth: '500px', margin: '0 auto', padding: '16px' }}>
                ...
                <div style={{ textAlign: 'center', marginBottom: '24px' }}>
                    ...
                    />
                    <button onClick={() => fileRef.current?.click()} style={{ color: 'var(--accent-blue)', fontWeight: 600 }}>
        ...
        <div style={{ maxWidth: '500px', margin: '0 auto' }}>
            ...
            {settingSections.map(section => (
                <div key={section.title} style={{ marginTop: '24px' }}>
                    <p style={{ padding: '0 20px 8px', fontWeight: 600, fontSize: 'var(--font-size-sm)', color: 'var(--text-secondary)' }}>
                        {section.title}
                    </p>
